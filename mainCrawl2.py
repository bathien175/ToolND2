...
def open_secondary_interface():
    ...
    import main as secondary  # Import file secondary.py và mở giao diện mới
...
---------------------+*****-:::--#%%%%%%%%%%%%%%%%%:::::-=--:::::=+===+*#*----#%%++*%*#%%###**###%%%%%%%%%%%%%#**##%%%%%%%%%%%%%%%%#*+=--#
    ...
    for model in listmodels:
        ...
        log_terminal(".........................Check thành công file csv................................")
        demstt = start_index
        breakSTT = 0
            ...
            while not success:
                try:
                    if breakSTT == 0:
                        ...
                        log_terminal(".........................Đang tiến hành cấu hình Chrome...........................")
                        ascii_nd2 = """
    .................................................................  ..-=+**++=====+**+=-:. .................................................................. 
    .................................................................:-+*+=-....:..:.:....:-+*+=:.................................................................
    .............................................................:=**+-..+=..*-+. ==+.+:=.-..:=**=:..............................................................
    ...
    .............................................................................................=:..................................................... ........
                        ...
                        log_terminal(".........................Khởi động duyệt WEBSITE..................................")
                        ...
                        form.submit()
                        time.sleep(2)
                        log_terminal(".........................Đăng nhập ẩn danh thành công.............................")
                        # Chọn
                        ...
                        liElement.click()
                        log_terminal(".........................Chuyển giao diện xem chi tiết............................")
                        log_terminal(".........................Hoàn tất việc hack trang WEBSITE.........................")
                        time.sleep(1)
                    cod = str(pt)
                    ...
                    btnFind.click()
                    time.sleep(0.5)
                    log_terminal(".........................Loading Tìm bệnh nhân thành công.............................")
                                    ...
                                    for di in drug_info:
                                        if  di.get('check_in_out_hospital_record_id') == 0:
                                            if di.get('prescription_id') == int(pl):
                                                ...
                                                foundDrug = True
                                                log_terminal(".........................Tìm đợt khám thành công.....................................")
                                                break
                                except:
                                    continue     
                        if foundDrug == True:
                    ...
                    if patient_result.code == "" or patient_result.primaryICD10 == "":
                        errorDrug += 1
                        log_terminal(f"Dữ liệu bệnh nhân trống, mã bệnh nhân {cod}")
                        if errorDrug >= 5:
...
menu_bar.add_cascade(label="Xuất báo cáo", menu=file_menu)
file_menu.add_command(label="Xuất báo cáo khám bệnh", command=open_secondary_interface)
